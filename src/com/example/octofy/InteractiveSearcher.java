...
public class InteractiveSearcher extends View {
    ...
    public InteractiveSearcher(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            circleText = a.getString(R.styleable.InteractiveSearcher_circleLabel);
            circleCol = a.getInteger(R.styleable.InteractiveSearcher_circleColor, 0);//0 is default
            labelCol = a.getInteger(R.styleable.InteractiveSearcher_labelColor, 0);
        } finally {
            a.recycle();
        }
    }
